        ...
        while (attemptRun <= maxAttemptsForRound) {
          ...
          if (!useExistingProgress) {
            ...
            const keepSettings = {
              ...
              outlookEmailPlusBaseUrl: prevState.outlookEmailPlusBaseUrl,
              outlookEmailPlusApiKey: prevState.outlookEmailPlusApiKey,
              outlookEmailPlusProvider: prevState.outlookEmailPlusProvider,
              outlookEmailPlusProjectKey: prevState.outlookEmailPlusProjectKey,
              outlookEmailPlusCallerIdPrefix: prevState.outlookEmailPlusCallerIdPrefix,
              outlookEmailPlusAliasMaxPerMailbox: prevState.outlookEmailPlusAliasMaxPerMailbox,
              currentOutlookEmailPlusClaim: prevState.currentOutlookEmailPlusClaim,
